...
INSERT INTO tasks (project_id, priority, assignee_id, name, description, start_date, due_date, modified_date, status, category_id, is_active) VALUES
  ...
  (2, 'Medium', 2, 'Sketch ERD', 'Create an ERD and get reviewed by mentor.', '2022-04-14','2025-04-18', '2022-04-18', 'In Progress', 3, true),
  ...
  -- PROJECT 5 LIST/BOARD VIEW FOR TASKS
  (5, 'High', 2, 'Table view', 'Implement trello board view for projects/tasks.', '2022-04-14','2022-04-25', '2022-04-27', 'Not Started', 7, true),
  (5, 'Medium', 3, 'Trello board view', 'implement trello board view for projects/tasks.', '2022-04-14','2022-04-26', '2022-04-26', 'Pending', 7, true),
  ...
  -- PROJECT 7 DASHBOARD COMPONENTS
  (7, 'Low', 1, 'Implement greeting panel', 'Show user current date and greet them with their name.', '2022-04-14','2022-04-23', '2022-04-23', 'Not Started', 5, true),
  (7, 'High', 2, 'Design user task panel', 'Need to create user specific panel for tasks.', '2022-04-14','2022-04-24', '2022-04-24', 'In Progress', 1, true),
  (7, 'High', 2, 'Quick add task feature', 'Implement quick add task feature for improved user experience.', '2022-04-14','2022-04-25', '2022-04-25', 'Pending', 2, true),
  (7, 'High', 1, 'Modify user projects panel', 'Need to modify user specific panel for projects.', '2022-04-14','2022-04-21', '2022-04-21', 'Pending', 2, true),
  (7, 'Medium', 2, 'Research example carousels', 'Find good examples of carousel designs, discuss with team and choose best.', '2022-04-14','2022-04-22', '2022-04-22', 'Complete', 1, true),
  (7, 'Medium', 3, 'Create button for adding project', 'Will need a button to trigger new project form modal.', '2022-04-14','2022-04-19', '2022-04-19', 'Complete', 4, true),
  ...
  (8, 'High', 2, 'Link inputs on projects form', 'Connect form and modal to the the all projects page.', '2022-04-14','2022-04-22', '2022-04-22', 'Not Started', 3, true),
  ...
  (10, 'Medium', 1, 'Test notifications', 'Setup notification for message board posts.', '2022-04-14','2022-04-25', '2022-04-22', 'Pending', 3, true),
