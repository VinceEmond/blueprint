...
INSERT INTO projects (owner_id, name, description, start_date, due_date, modified_date, status, category_id, is_active) VALUES
  ...
  (3, 'Project planning', 'Plan the things required for the project', '2022-04-14','2022-04-29', '2022-04-28', 'Complete', 2, true),
  (2, 'Backend API', 'Create API and routes required', '2022-04-15','2022-04-29', '2022-04-26', 'Pending', 3, true),
  (1, 'Database', 'Setup PostgreSQL database', '2022-04-18','2022-04-29', '2022-04-20', 'Pending', 1, true),
  ...
  (1, 'Dashboard components', 'Create dynamic message, carousel, and quick add task components', '2022-04-03','2022-04-18', '2022-04-17', 'In Progress', 2, true),
