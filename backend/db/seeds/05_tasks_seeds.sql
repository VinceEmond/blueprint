...
INSERT INTO tasks (project_id, priority, assignee_id, name, description, start_date, due_date, modified_date, status, category_id, is_active) VALUES
  ...
  (8, 'High', 2, 'Task K Name', 'Task K Description: . Kevin shank bacon, andouille tenderloin', '2022-04-14','2022-04-22', '2022-04-22', 'Not Started', 3, true),
  (8, 'Medium', 3, 'Task L Name', 'Task L Description: atback. Strip steak beef ribs pancetta short', '2022-04-14','2022-04-23', '2022-04-23', 'Pending', 4, true),
  ...
  (10, 'Medium', 1, 'Implement notification for message board', 'Setup notification for message board posts', '2022-04-14','2022-04-25', '2022-04-22', 'Pending', 3, true),
  ...
  (12, 'Medium', 3, 'Design preliminary navbar with all routes', 'Add links to main pages (Dashboard, Tasks, Projects), maybe login feature in future.', '2022-04-14','2022-04-27', '2022-04-26', 'Pending', 1, true),
  (12, 'High', 2, 'Implement react-router-dom for main routes', 'React-router-dom will allow us to manage routes from the frontend.', '2022-04-14','2022-04-28', '2022-04-27', 'In Progress', 3, true),

  -- -- PROJECT 13 APPLICATION STYLING
  (13, 'High', 2, 'Task K Name', 'Task K Description: . Kevin shank bacon, andouille tenderloin', '2022-04-14','2022-04-29', '2022-04-28', 'Not Started', 5, true),
  (13, 'Medium', 1, 'Task L Name', 'Task L Description: atback. Strip steak beef ribs pancetta short', '2022-04-14','2022-04-28', '2022-04-27', 'Pending', 4, true),
  ...
  (13, 'Medium', 3, 'Design carousel card layout', 'Decide what information is most important for each project, choose best layout for each card.', '2022-04-14','2022-04-25', '2022-04-27', 'Complete', 3, true)
;
