...
INSERT INTO projects (owner_id, name, description, start_date, due_date, modified_date, status, category_id, is_active) VALUES
  (1, 'Project 1 Name', 'Project1 description: Cow drumstick chislic burgdoggen kevin, pig alcatra salami turkey chicken. Turkey leberkas alcatra, filet mignon meatball ground round tri-tip bacon biltong ball tip ribeye', '2022-04-01', '2022-04-06', '2022-04-11', 'Not Started', 1, true),
